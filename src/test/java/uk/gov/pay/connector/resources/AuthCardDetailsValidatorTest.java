...
public class AuthCardDetailsValidatorTest {
    ...
    @Test
    public void validationFailsIfUserAgentHeaderContainsMoreThanElevenDigits() {
        AuthCardDetails authCardDetails = aValidAuthorisationDetails();
        authCardDetails.setUserAgentHeader(sneakyCardNumber);
        assertFalse(AuthCardDetailsValidator.isWellFormatted(authCardDetails));
    }

    @Test
    public void validationSucceedsIfUserAgentHeaderContainsExactlyElevenDigits() {
        AuthCardDetails authCardDetails = aValidAuthorisationDetails();
        authCardDetails.setUserAgentHeader("Mozilla/1.2 (Windows 34; build 56789) 1.2");
        assertTrue(AuthCardDetailsValidator.isWellFormatted(authCardDetails));
    }

    @Test
    public void validationSucceedsIfUserAgentHeaderIsNull() {
        AuthCardDetails authCardDetails = aValidAuthorisationDetails();
        authCardDetails.setUserAgentHeader(null);
        assertTrue(AuthCardDetailsValidator.isWellFormatted(authCardDetails));
    }

    @Test
    public void validationFailsIfAcceptHeaderContainsMoreThanElevenDigits() {
        AuthCardDetails authCardDetails = aValidAuthorisationDetails();
        authCardDetails.setAcceptHeader(sneakyCardNumber);
        assertFalse(AuthCardDetailsValidator.isWellFormatted(authCardDetails));
    }

    @Test
    public void validationSucceedsIfAcceptHeaderContainsExactlyElevenDigits() {
        AuthCardDetails authCardDetails = aValidAuthorisationDetails();
        authCardDetails.setAcceptHeader("application/format-123456789-01");
        assertTrue(AuthCardDetailsValidator.isWellFormatted(authCardDetails));
    }

    @Test
    public void validationSucceedsIfAcceptHeaderIsNull() {
        AuthCardDetails authCardDetails = aValidAuthorisationDetails();
        authCardDetails.setAcceptHeader(null);
        assertTrue(AuthCardDetailsValidator.isWellFormatted(authCardDetails));
    }
